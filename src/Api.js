...
class JoblyApi {
  ...
  static async signup({username, password, email, firstName, lastName}) {
    let res = await this.request(`auth/register`, {username, password, email, firstName, lastName}, "post")
    return res.token;
  }
  ...
  static async updateUser({username, password, email, firstName, lastName}) {
    let res = await this.request(`users/${username}`, {password, email, firstName, lastName}, "patch")
    return res.user;
  }
